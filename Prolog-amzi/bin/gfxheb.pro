...
% load_picture(File).
% Loads a picture to current window.
% Not very usefull, better use paste_graphics.
...
/*
dynamic_function(WindowID,ControlID,Event) :- todo.
הגדרה של חוק דינמי שמוסיפים ליחידות בדרך כלל.
 לכל יחידה יש מצבים שיכולים להתרחש ועל כל מצב אפשר להגדיר פעולה כזאת.
*/
