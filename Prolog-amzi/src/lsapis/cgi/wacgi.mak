...
!IF "$(CFG)" != "wacgi - Win32 Release" && "$(CFG)" != "wacgi - Win32 Debug"
...
LINK32=link.exe
LINK32_FLAGS=$(AMZI_DEV_DIR)\lib\amzi.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\acgi.pdb" /machine:I386 /out:"$(AMZI_DEV_DIR)\lsapis\cgi\acgi.exe" 
LINK32_OBJS= \
	"$(INTDIR)\amzicgi.obj" \
	"$(INTDIR)\amzisub.obj"
...
CPP=cl.exe
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "$(AMZI_DEV_DIR)\include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\wacgi.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=$(AMZI_DEV_DIR)\lib\amzi.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\acgi.pdb" /debug /machine:I386 /out:"$(AMZI_DEV_DIR)\lsapis\cgi\acgi.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\amzicgi.obj" \
	"$(INTDIR)\amzisub.obj"
